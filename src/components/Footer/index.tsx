  ...
  return (
    <footer className={styles.container}>
      ...
      <div className={styles.container__esquerda}>
        <a className={styles.logoUrso} href="/" target="_blank"><img src={urso} alt="Logo Urso" /></a>
      ...
      <div className={styles.container__central}>
        <div className={styles.container__links}>
          <a href="https://open.spotify.com/show/5J1scP1l7m7kXK6v5RZS7J?si=27d5abb36c16408f&nd=1&dlsi=e313a2412f91422d"  target="_blank"><img src={LogoSpotify} alt="Logo do Spotify ela redireciona para o podcast pipoca agil" /></a>
          <a href="https://www.youtube.com/@PipocaAgil" target="_blank"><img src={LogoYoutube} alt="Logo do youtube ela redireciona para o canal do pipoca agil" /></a>
          <a href="https://www.linkedin.com/company/pipoca-%C3%A1gil/"  target="_blank"><img src={LogoLinkedin} alt="Logo do linkedin ela redireciona para o perfil do pipoca agil " /></a>
        </div>
